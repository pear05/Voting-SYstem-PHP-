...
<body>
    <div class="registerform">
        ...
        <form action="" method="POST" >
            ...
            <input type="tel"  name="MobileNo"  maxlength="10" required placeholder="Mobile NO"><br>
...
if($Password==$RePassword){
   ...
   if($run_insert===true){
       echo "<H5 style='color:green;text-align:center;'>Successfully Registered</h5>";
   }else{
       echo "<H5 style='color:red;text-align:center;'>Not successful</h5>".mysqli_error($conn);
   }
}else{
